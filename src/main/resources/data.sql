...
-- password is 'pwd'
INSERT INTO pizzeria_user (id, name, username, password, email, roles) VALUES (4, 'Rando Shtishi', 'rshtishi', '$2a$10$qLMAGXRRqkDzasIeyj07A.DirP2OdgG21Hmw1a2nYhirLoadfpYnu', 'rshtishi@pizza.net', '["CUSTOMER", "PIZZA_MAKER"]') ON CONFLICT DO NOTHING;
-- password is 'test'
